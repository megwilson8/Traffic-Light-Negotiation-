function [scenario, egoVehicle] = scenarioedit()
% createDrivingScenario Returns the drivingScenario defined in the Designer

% Generated by MATLAB(R) 9.14 (R2023a) and Automated Driving Toolbox 3.7 (R2023a).
% Generated on: 04-Sep-2023 13:13:04

% Construct a drivingScenario object.
scenario = drivingScenario('StopTime', 11, ...
    'SampleTime', 0.1);
...
pedestrian = actor(scenario, ...
    ...
    'Width', 0.45, ...
    'Height', 1.7, ...
    'Position', [-79.0772109886515 3.88939524418103 0], ...
    'RCSPattern', [-8 -8;-8 -8], ...
    'Mesh', driving.scenario.pedestrianMesh, ...
    'PlotColor', [0 0.447 0.741], ...
    'Name', 'Pedestrian');
waypoints = [-79.0772109886515 3.88939524418103 0;
    -79.3 -3.9 0];
speed = [1.5;1.5];
